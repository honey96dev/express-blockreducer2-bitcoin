...
ChartDataService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
/* harmony import */ var angular_plotly_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! angular-plotly.js */ "./node_modules/angular-plotly.js/fesm2015/angular-plotly.js.js");
...
let PriceChartComponent = class PriceChartComponent {
    constructor(titleService, formBuilder, chartDataService) {
        this.titleService = titleService;
        this.formBuilder = formBuilder;
    ...
    onSubmit() {
        ...
        const symbol = 'XBTUSD';
        const binSize = '5m';
        const datePipe = new _angular_common__WEBPACK_IMPORTED_MODULE_2__["DatePipe"]('en');
